...
#define NODE_MAIN_LOGGER_NAME "socket_can_sender_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsocket_can_sender_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<drivers::socketcan::SocketCanSenderNode>";
